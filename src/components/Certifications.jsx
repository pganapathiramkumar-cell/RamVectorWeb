...
const certGroups = [
  {
    ...
    abbr: 'AZ',
    certs: [
      { name: 'Microsoft Certified: Azure Solutions Architect Expert', code: 'AZ-305',  validity: 'Expires Jun 2026', credId: '2E0F6745D2329A76' },
      { name: 'Microsoft Certified: DevOps Engineer Expert',           code: 'AZ-400',  validity: 'Expires Jun 2026', credId: 'BCDBFD24151AFDF2' },
      { name: 'Microsoft Certified: Azure Virtual Desktop Specialty',  code: 'AZ-140',  validity: 'Expires Dec 2026', credId: 'A6F6C30E6CCF9E4A' },
      { name: 'Microsoft Certified: Azure Administrator Associate',    code: 'AZ-104',  validity: 'Expires Jul 2026', credId: '3F9790DB166F8EF5' },
      { name: 'Microsoft Certified: Azure Fundamentals',              code: 'AZ-900',  validity: 'Issued Dec 2022',  credId: '4D52F421641FD5CF' },
      { name: 'Microsoft Certified: Azure Network Engineer Associate', code: 'AZ-700',  validity: 'Expired Jun 2025', credId: 'B82314B74FC4250D', expired: true },
